// Borrowed from https://github.com/cosanet/cosanet/blob/master/internal/controller_resolver/controller_resolver.go
...
func NewResolver(opts *ResolverOptions) PodControllerResolver {
	...
	if kubeconfig := os.Getenv("KUBECONFIG"); kubeconfig != "" {
		...
		if err != nil {
			slog.Error("failed to build in-cluster config", slog.Any("err", err))
			return &noopResolver{}
		}
	}
	...
	if err != nil {
		slog.Error("failed to create clientset", slog.Any("err", err))
		return &noopResolver{}
	}
